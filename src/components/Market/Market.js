                            ...
                            <div className="products">
                                {listaDeProdutos.map((product, index) => (
                                    <div className="product" id={index}>
                                        <h3>{product.nome}</h3>
                                        <div><img src={`/img/${product.imagemSrc}.jpg`} alt={product.nome} /></div>
                            ...
                            <div className={`products ${nomeDaCategoria}`}>
                                ...
                                {productsList[nomeDaCategoria].map((product, index) => (
                                    <div className="product" id={product.codigo}>
                                        ...
                                        <div className="buttons">
                                            <ButtomWhatsapp texto={"Comprar"} link={`Olá! Gostaria de saber mais sobre o ${product.nome} que está anunciada no site!`} />
                                        </div>
                                    </div>
                                ))}
                            </div>
